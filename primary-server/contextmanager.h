...
#ifndef CONTEXT_MANAGER_DEF
#define CONTEXT_MANAGER_DEF
...
class ContextManager {
  /** Action is the cleanup code to run.  It's a std::function, so probably a lambda */
...
public:
  /** Construct a ContextManager by providing a function (lambda) to run on destruct */
  ...
  /** Cancel the action, to keep it from running when this object goes out of scope */
